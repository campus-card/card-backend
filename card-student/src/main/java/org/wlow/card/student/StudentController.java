...
public class StudentController {
    ...
    public Response registerCard(@RequestParam
    ...
    public Response recharge(@RequestParam
    ...
    public Response purchase(@RequestParam
                                 Integer productId,
                             @RequestParam
    ...
    public Response getPurchaseRecord(@RequestParam
