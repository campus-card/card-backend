...
public class ShopController {
    ...
    public Response<String> addProduct(@RequestParam
    ...
    public Response<String> deleteProduct(@RequestParam Integer id) {
    ...
    public Response<Product> modifyProduct(@RequestParam Integer id,
                                           @RequestParam(required = false)
                                           String name,
                                           @RequestParam(required = false)
                                           @Nullable
    ...
    public Response<DTOPage<PurchaseRecord>> getSalesRecord(@RequestParam
                                                            @Positive(message = "页码必须为正数")
                                                            Integer page,
                                                            @RequestParam
                                                            @Positive(message = "每页数量必须为正数")
